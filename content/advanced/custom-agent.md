...
- [Talon](https://github.com/MugenFramework/Talon) - minimal Windows custom agent example (x64, C)
- [Karasu](https://github.com/MugenFramework/Karasu) - minimal Linux custom agent example (x64, C)
